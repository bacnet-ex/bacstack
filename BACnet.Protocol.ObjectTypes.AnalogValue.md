# `BACnet.Protocol.ObjectTypes.AnalogValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/analog_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.AnalogValue{
