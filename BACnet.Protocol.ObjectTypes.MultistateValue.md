# `BACnet.Protocol.ObjectTypes.MultistateValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/multistate_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.MultistateValue{
