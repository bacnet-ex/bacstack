# `BACnet.Protocol.ObjectTypes.StructuredView`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/structured_view.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.StructuredView{
  ...
  subordinate_annotations: [String.t()] | nil,
  subordinate_list: [BACnet.Protocol.DeviceObjectRef.t()]
}
```
