# `BACnet.Protocol.ObjectTypes.TrendLog`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/trend_log.ex#L1)
...
| start_time | <a title="%BACnet.Protocol.BACnetDateTime{date: %BACnet.Protocol.BACnetDate{year: :unspecified, month: :unspecified, day: :unspecified, weekday: :unspecified}, time: %BACnet.Protocol.BACnetTime{hour: :unspecified, minute: :unspecified, second: :unspecified, hundredth: :unspecified}}">`%BACnet.Protocol.BACnetDateTime{...}`</a> |  |
| stop_time | <a title="%BACnet.Protocol.BACnetDateTime{date: %BACnet.Protocol.BACnetDate{year: :unspecified, month: :unspecified, day: :unspecified, weekday: :unspecified}, time: %BACnet.Protocol.BACnetTime{hour: :unspecified, minute: :unspecified, second: :unspecified, hundredth: :unspecified}}">`%BACnet.Protocol.BACnetDateTime{...}`</a> |  |
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.TrendLog{
  ...
  log_buffer: [BACnet.Protocol.LogRecord.t()],
  log_device_object_property: BACnet.Protocol.DeviceObjectPropertyRef.t(),
  log_interval: non_neg_integer(),
  logging_type: BACnet.Protocol.Constants.logging_type(),
