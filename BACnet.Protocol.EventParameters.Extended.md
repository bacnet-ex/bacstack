# `BACnet.Protocol.EventParameters.Extended`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/event_parameters.ex#L238)
...
```elixir
@type t() :: %BACnet.Protocol.EventParameters.Extended{
  extended_event_type: non_neg_integer(),
