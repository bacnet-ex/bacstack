# `BACnet.Protocol.ObjectTypes.File`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/file.ex#L1)
...
| file_size | `0` |  |
| file_type | `"regular"` |  |
| modification_date | <a title="%BACnet.Protocol.BACnetDateTime{date: %BACnet.Protocol.BACnetDate{year: :unspecified, month: :unspecified, day: :unspecified, weekday: :unspecified}, time: %BACnet.Protocol.BACnetTime{hour: :unspecified, minute: :unspecified, second: :unspecified, hundredth: :unspecified}}">`%BACnet.Protocol.BACnetDateTime{...}`</a> |  |
</details>
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.File{
  ...
  file_type: String.t(),
  modification_date: BACnet.Protocol.BACnetDateTime.t(),
