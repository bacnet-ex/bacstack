defmodule BACnet.Stack.Transport.MstpTransport.EncodingTools do
  ...
  """
  @spec calculate_header_crc(iodata() | binary() | byte(), non_neg_integer()) :: non_neg_integer()
  ...
  defp cobs_do_decode(
    ...
    cobs_do_decode_finish(crc_code, crc_data, byte_size(crc_data), first_acc, result_acc, crc32k)
  end
