defmodule BACnet.Protocol.EventAlgorithms.ChangeOfLifeSafety do
  ...
  opaquedstruct do
    ...
    field(:monitored_value, Constants.life_safety_state(), required: true)
    field(:mode, Constants.life_safety_mode(), required: true)
    field(:status_flags, StatusFlags.t(), required: true)
    field(:operation_expected, Constants.life_safety_operation(), required: true)
    ...
    field(:dt_life_alarm, DateTime.t() | nil, required: true)
    field(:last_value, Constants.life_safety_operation(), required: false)
    field(:last_mode, Constants.life_safety_mode(), required: false)
  end
