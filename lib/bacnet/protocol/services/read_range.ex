defmodule BACnet.Protocol.Services.ReadRange do
  ...
  @type range ::
          {:by_position,
           {reference_index :: non_neg_integer(), count :: ApplicationTags.unsigned16()}}
          | {:by_seq_number,
             {reference_seq_number :: ApplicationTags.unsigned32(),
              count :: ApplicationTags.unsigned16()}}
          | {:by_time,
             {reference_time :: Protocol.BACnetDateTime.t(),
              count :: ApplicationTags.unsigned16()}}
  ...
  def from_apdu(
    ...
    with {:ok, object, rest} <-
         ...
         prop_identifier <- Constants.by_value_safe(:property_identifier, property, property),
         :ok <-
  ...
  defp parse_range([
    ...
    {:ok, {:by_time, {%Protocol.BACnetDateTime{date: ref_date, time: ref_time}, count}}}
  end
