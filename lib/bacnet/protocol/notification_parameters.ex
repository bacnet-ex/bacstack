defmodule BACnet.Protocol.NotificationParameters do
  ...
  defmodule ChangeOfBitstring do
    ...
    """
    typedstruct do
      field(:referenced_bitstring, tuple(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
    end
  ...
  defmodule ChangeOfState do
    ...
    """
    typedstruct do
      field(:new_state, PropertyState.t(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
    end
  ...
  defmodule ChangeOfValue do
    ...
    """
    typedstruct do
      field(:changed_bits, tuple(), required: false)
      field(:changed_value, float(), required: false)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
    end
  ...
  defmodule CommandFailure do
    ...
    """
    typedstruct do
      field(:command_value, BACnet.Protocol.ApplicationTags.Encoding.t(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
  ...
  defmodule FloatingLimit do
    ...
    """
    typedstruct do
      field(:reference_value, float(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:setpoint_value, float(), required: true)
      field(:error_limit, float(), required: true)
    end
  ...
  defmodule OutOfRange do
    ...
    """
    typedstruct do
      field(:exceeding_value, float(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:deadband, float(), required: true)
      field(:exceeded_limit, float(), required: true)
    end
  ...
  defmodule ComplexEventType do
    ...
    """
    typedstruct do
      field(:property_values, [BACnet.Protocol.PropertyValue.t()], required: true)
    end
  ...
  defmodule ChangeOfLifeSafety do
    ...
    """
    typedstruct do
      field(:new_state, BACnet.Protocol.Constants.life_safety_state(), required: true)
      field(:new_mode, BACnet.Protocol.Constants.life_safety_mode(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)

      field(:operation_expected, BACnet.Protocol.Constants.life_safety_operation(),
        required: true
      )
    end
  ...
  defmodule Extended do
    ...
    typedstruct do
      ...
      field(:extended_notification_type, non_neg_integer(), required: true)
      field(:parameters, [BACnet.Protocol.ApplicationTags.Encoding.t()], required: true)
    end
  ...
  defmodule BufferReady do
    ...
    """
    typedstruct do
      field(:buffer_property, DeviceObjectPropertyRef.t(), required: true)
      field(:previous_notification, BACnet.Protocol.ApplicationTags.unsigned32(), required: true)
      field(:current_notification, BACnet.Protocol.ApplicationTags.unsigned32(), required: true)
    end
  ...
  defmodule UnsignedRange do
    ...
    """
    typedstruct do
      field(:exceeding_value, non_neg_integer(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:exceeded_limit, non_neg_integer(), required: true)
    end
  ...
  defmodule SignedOutOfRange do
    ...
    """
    typedstruct do
      field(:exceeding_value, integer(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:deadband, non_neg_integer(), required: true)
      field(:exceeded_limit, integer(), required: true)
    end
  ...
  defmodule ChangeOfCharacterString do
    ...
    """
    typedstruct do
      field(:changed_value, String.t(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:alarm_value, String.t(), required: true)
    end
  ...
  defmodule ChangeOfStatusFlags do
    ...
    typedstruct do
      ...
      field(:referenced_flags, BACnet.Protocol.StatusFlags.t(), required: true)
    end
  ...
  defmodule ChangeOfReliability do
    ...
    """
    typedstruct do
      field(:reliability, BACnet.Protocol.Constants.reliability(), required: true)
      field(:status_flags, BACnet.Protocol.StatusFlags.t(), required: true)
      field(:property_values, [BACnet.Protocol.PropertyValue.t()], required: true)
    end
      ...
      [
        ...
        with {:ok, {dev_obj_ref, _rest}} <- DeviceObjectPropertyRef.parse(devobjref_raw),
             ...
             {:ok, {:unsigned_integer, current_notification}} <-
               ApplicationTags.unfold_to_type(:unsigned_integer, current_notification_raw) do
  ...
  def encode(%BufferReady{} = params, opts) do
    with true <- is_struct(params.buffer_property, DeviceObjectPropertyRef),
         true <- is_integer(params.previous_notification) and params.previous_notification >= 0,
         true <- is_integer(params.current_notification) and params.current_notification >= 0,
