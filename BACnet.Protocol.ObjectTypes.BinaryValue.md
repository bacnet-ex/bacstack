# `BACnet.Protocol.ObjectTypes.BinaryValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/binary_value.ex#L1)
...
| change_of_state_time | <a title="%BACnet.Protocol.BACnetDateTime{date: %BACnet.Protocol.BACnetDate{year: :unspecified, month: :unspecified, day: :unspecified, weekday: :unspecified}, time: %BACnet.Protocol.BACnetTime{hour: :unspecified, minute: :unspecified, second: :unspecified, hundredth: :unspecified}}">`%BACnet.Protocol.BACnetDateTime{...}`</a> |  |
| elapsed_active_time | `0` |  |
| inactive_text | `"Inactive"` |  |
| polarity | `:normal` |  |
| time_of_active_time_reset | <a title="%BACnet.Protocol.BACnetDateTime{date: %BACnet.Protocol.BACnetDate{year: :unspecified, month: :unspecified, day: :unspecified, weekday: :unspecified}, time: %BACnet.Protocol.BACnetTime{hour: :unspecified, minute: :unspecified, second: :unspecified, hundredth: :unspecified}}">`%BACnet.Protocol.BACnetDateTime{...}`</a> |  |
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.BinaryValue{
  ...
  change_of_state_count: BACnet.Protocol.ApplicationTags.unsigned32() | nil,
