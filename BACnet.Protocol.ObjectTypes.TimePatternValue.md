...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/time_pattern_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.TimePatternValue{
