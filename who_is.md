...
Code (taken from file `examples/who_is.exs`):
...
- if installed as dependency: `mix run deps/bacstack/examples/who_is.exs`
- if working on bacstack: `mix run examples/who_is.exs`
