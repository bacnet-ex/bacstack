...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/date_pattern_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.DatePatternValue{
  ...
  present_value: BACnet.Protocol.BACnetDate.t(),
  priority_array:
    BACnet.Protocol.PriorityArray.t(BACnet.Protocol.BACnetDate.t()) | nil,
  profile_name: String.t() | nil,
  reliability: BACnet.Protocol.Constants.reliability() | nil,
  reliability_evaluation_inhibit: boolean() | nil,
  relinquish_default: BACnet.Protocol.BACnetDate.t() | nil,
...
@spec get_priority_value(t()) ::
  {priority :: 1..16, value :: BACnet.Protocol.BACnetDate.t()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, BACnet.Protocol.BACnetDate.t() | nil) ::
  {:ok, t()} | property_update_error()
```
