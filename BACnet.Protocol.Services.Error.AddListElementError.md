# `BACnet.Protocol.Services.Error.AddListElementError`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/services/error/add_list_element_error.ex#L1)

# `t`

```elixir
@type t() :: %BACnet.Protocol.Services.Error.AddListElementError{
