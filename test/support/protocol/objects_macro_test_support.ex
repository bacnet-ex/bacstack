...
defmodule BACnet.Test.Support.Protocol.ObjectsMacroTestSupport.BacObjectMinimalDocsStub3 do
  @moduledoc """
  Hello there.
  """
  ...
  bac_object :accumulator do
    services(intrinsic: true)

    field(:description, String.t())
    field(:device_type, String.t())
    field(:out_of_service, boolean(), required: true)
    field(:present_value, boolean(), required: true)
  end
end
