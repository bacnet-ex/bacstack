defmodule BACnet.Test.Protocol.ConstantsTest do
  ...
  test "assert by_name_safe/3 works" do
    assert 0x3FF = Constants.by_name_safe(:asn1, :max_object, 155)
  end

  test "assert by_name_safe/3 returns default" do
    assert 155 = Constants.by_name_safe(:asn1, :max_object_non, 155)
  end
  ...
  test "assert by_value_safe/3 works" do
    assert :max_object = Constants.by_value_safe(:asn1, 0x3FF, 155)
  end

  test "assert by_value_safe/3 returns default" do
    assert 155 = Constants.by_value_safe(:asn1, :hello, 155)
  end
