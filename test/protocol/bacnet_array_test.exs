defmodule BACnet.Protocol.BACnetArrayTest do
  ...
  test "get size array" do
    assert 0 == BACnetArray.get_size(BACnetArray.new())
    assert 3 == BACnetArray.get_size(BACnetArray.new(3))
    assert 5 == BACnetArray.get_size(BACnetArray.from_list([5, 6, 8, 23, 51]))
  end
