defmodule BACnet.Test.Protocol.Services.ConfirmedCovNotificationTest do
  ...
  test "is confirmed" do
    assert true == ConfirmedCovNotification.confirmed?()
  end
  ...
  test "decoding ConfirmedCovNotification with date time" do
    assert {:ok,
            %ConfirmedCovNotification{
  ...
  test "protocol implementation is confirmed" do
    assert true ==
             ServicesProtocol.confirmed?(%ConfirmedCovNotification{
               process_identifier: 99,
               initiating_device: %BACnet.Protocol.ObjectIdentifier{
                 type: :device,
                 instance: 86_001
