...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/date_time_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.DateTimeValue{
