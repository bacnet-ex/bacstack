# `BACnet.Protocol.ObjectTypes.BitstringValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/bitstring_value.ex#L1)
...
|----------|---------------|---------------|
| alarm_values | `[]` |  |
| bit_text | <a title="#BACnet.Protocol.BACnetArray<size: 0, items: [], fixed_size: nil>">`%BACnet.Protocol.BACnetArray{...}`</a> |  |
</details>
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.BitstringValue{
  ...
  alarm_values: [tuple()] | nil,
  bit_mask: tuple() | nil,
  bit_text: BACnet.Protocol.BACnetArray.t(String.t()) | nil,
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: tuple()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, tuple() | nil) :: {:ok, t()} | property_update_error()
```
