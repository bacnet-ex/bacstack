...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/event_algorithms/change_of_bitstring.ex#L1)
...
```elixir
@spec new(tuple(), BACnet.Protocol.EventParameters.ChangeOfBitstring.t()) :: t()
```
