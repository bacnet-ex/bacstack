...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/character_string_value.ex#L1)
...
|----------|---------------|---------------|
| alarm_values | <a title="#BACnet.Protocol.BACnetArray<size: 0, items: [], fixed_size: nil>">`%BACnet.Protocol.BACnetArray{...}`</a> |  |
| fault_values | <a title="#BACnet.Protocol.BACnetArray<size: 0, items: [], fixed_size: nil>">`%BACnet.Protocol.BACnetArray{...}`</a> |  |
</details>
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.CharacterStringValue{
  ...
  alarm_values: BACnet.Protocol.BACnetArray.t(String.t() | nil) | nil,
  ...
  fault_values: BACnet.Protocol.BACnetArray.t(String.t() | nil) | nil,
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: String.t()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, String.t() | nil) ::
  {:ok, t()} | property_update_error()
```
