# `BACnet.Protocol.ObjectTypes.IntegerValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/integer_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.IntegerValue{
  ...
  high_limit: integer() | nil,
  limit_enable: BACnet.Protocol.LimitEnable.t() | nil,
  low_limit: integer() | nil,
  max_present_value: integer() | nil,
  min_present_value: integer() | nil,
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: integer()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, integer() | nil) ::
  {:ok, t()} | property_update_error()
```
