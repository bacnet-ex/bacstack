# `BACnet.Protocol.ObjectTypes.OctetStringValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/octet_string_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.OctetStringValue{
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: binary()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, binary() | nil) :: {:ok, t()} | property_update_error()
```
