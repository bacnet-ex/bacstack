# `BACnet.Protocol.Services.Error.RemoveListElementError`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/services/error/remove_list_element_error.ex#L1)

# `t`

```elixir
@type t() :: %BACnet.Protocol.Services.Error.RemoveListElementError{
