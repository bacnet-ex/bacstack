# `BACnet.Protocol.ObjectTypes.LargeAnalogValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/large_analog_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.LargeAnalogValue{
