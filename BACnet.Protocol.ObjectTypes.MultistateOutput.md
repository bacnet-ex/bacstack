# `BACnet.Protocol.ObjectTypes.MultistateOutput`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/multistate_output.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.MultistateOutput{
  ...
  feedback_value: pos_integer() | nil,
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: pos_integer()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, pos_integer() | nil) ::
  {:ok, t()} | property_update_error()
```
