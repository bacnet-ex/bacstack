...
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/calendar.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.Calendar{
  ...
  date_list: [BACnet.Protocol.CalendarEntry.t()],
