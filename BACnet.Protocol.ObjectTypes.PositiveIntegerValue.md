# `BACnet.Protocol.ObjectTypes.PositiveIntegerValue`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/positive_integer_value.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.PositiveIntegerValue{
  ...
  cov_increment: non_neg_integer() | nil,
  deadband: non_neg_integer() | nil,
  ...
  max_present_value: non_neg_integer() | nil,
  min_present_value: non_neg_integer() | nil,
...
```elixir
@spec get_priority_value(t()) :: {priority :: 1..16, value :: non_neg_integer()} | nil
```
...
```elixir
@spec set_priority(t(), 1..16, non_neg_integer() | nil) ::
  {:ok, t()} | property_update_error()
```
