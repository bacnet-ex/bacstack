# `BACnet.Protocol.Services.Error.CreateObjectError`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/services/error/create_object_error.ex#L1)

# `t`

```elixir
@type t() :: %BACnet.Protocol.Services.Error.CreateObjectError{
