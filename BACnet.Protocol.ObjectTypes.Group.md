# `BACnet.Protocol.ObjectTypes.Group`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/object_types/group.ex#L1)
...
```elixir
@type t() :: %BACnet.Protocol.ObjectTypes.Group{
  ...
  list_of_group_members: [BACnet.Protocol.AccessSpecification.t()],
  object_instance: non_neg_integer(),
  object_name: String.t(),
  present_value: [BACnet.Protocol.ReadAccessResult.t()],
