# `BACnet.Protocol.NotificationParameters.OutOfRange`
[🔗](https://github.com/bacnet-ex/bacstack/blob/master/lib/bacnet/protocol/notification_parameters.ex#L178)
...
```elixir
@type t() :: %BACnet.Protocol.NotificationParameters.OutOfRange{
  deadband: float(),
